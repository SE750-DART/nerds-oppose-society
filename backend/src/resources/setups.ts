...
export default <Setup[]>[
  {
    setup: "Hey Reddit! I'm __________. Ask me anything.",
  ...
  {
    setup: "TSA guidelines now prohibit __________ on airplanes.",
    type: SetupType.pickOne,
  },
  {
    setup:
  ...
  {
    setup: "Instead of coal, Santa now gives the bad children __________.",
    type: SetupType.pickOne,
  },
  {
    setup:
  ...
  {
    setup: "Maybe she's born with it. Maybe it's __________.",
    type: SetupType.pickOne,
  },
  {
  ...
  {
    setup: "Just saw this upsetting video! Please retweet!! #stop__________",
    type: SetupType.pickOne,
  },
  {
    setup:
  ...
  {
    setup: "The class field trip was completely ruined by __________.",
    type: SetupType.pickOne,
  },
  ...
  {
    setup: "I got 99 problems but __________ ain't one.",
    type: SetupType.pickOne,
  },
  { setup: "__________. It's a trap!", type: SetupType.pickOne },
  {
    setup:
  ...
  {
    setup: "Coming to Broadway this season, __________: The Musical.",
    type: SetupType.pickOne,
  },
  {
    setup:
  ...
  {
    setup: "But before I kill you, Mr. Bond, I must show you __________.",
    type: SetupType.pickOne,
  },
  {
    setup:
